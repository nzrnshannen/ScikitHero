      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[101] w-[90%] max-w-md bg-surface-raised/90 backdrop-blur-xl border border-border-medium p-6 md:p-8 rounded-2xl shadow-2xl print:hidden overflow-hidden"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
              className="absolute top-4 right-4 p-2 rounded-full hover:bg-surface-overlay transition-colors text-text-secondary hover:text-text-primary"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-surface/50 border border-border-medium text-text-primary rounded-xl py-2.5 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all placeholder:text-text-muted"
                />
              </div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  className="w-full bg-surface/50 border border-border-medium text-text-primary rounded-xl py-2.5 pl-10 pr-4 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all resize-none placeholder:text-text-muted"
                ></textarea>
              </div>
