import { FileDown, Cpu, Sparkles } from 'lucide-react'
...
export default function TopNavbar({ contentRef, activeTopic }) {
  const exportPdf = usePdfExport(contentRef, activeTopic)

  return (
    <header
      className="flex h-14 items-center justify-between border-b border-white/[0.06] bg-surface-raised/80 px-6 backdrop-blur-xl no-print"
      data-no-print
    >
